...
public final class InventoryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.stakhovskyi.grpc.Order.InventoryRequest,
      com.stakhovskyi.grpc.Order.InventoryResponse> getIsInStockMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IsInStock",
      requestType = com.stakhovskyi.grpc.Order.InventoryRequest.class,
      responseType = com.stakhovskyi.grpc.Order.InventoryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stakhovskyi.grpc.Order.InventoryRequest,
      com.stakhovskyi.grpc.Order.InventoryResponse> getIsInStockMethod() {
    io.grpc.MethodDescriptor<com.stakhovskyi.grpc.Order.InventoryRequest, com.stakhovskyi.grpc.Order.InventoryResponse> getIsInStockMethod;
      ...
      synchronized (InventoryServiceGrpc.class) {
        if ((getIsInStockMethod = InventoryServiceGrpc.getIsInStockMethod) == null) {
          InventoryServiceGrpc.getIsInStockMethod = getIsInStockMethod =
              io.grpc.MethodDescriptor.<com.stakhovskyi.grpc.Order.InventoryRequest, com.stakhovskyi.grpc.Order.InventoryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "IsInStock"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stakhovskyi.grpc.Order.InventoryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stakhovskyi.grpc.Order.InventoryResponse.getDefaultInstance()))
  ...
  public static abstract class InventoryServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void isInStock(com.stakhovskyi.grpc.Order.InventoryRequest request,
        io.grpc.stub.StreamObserver<com.stakhovskyi.grpc.Order.InventoryResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.stakhovskyi.grpc.Order.InventoryRequest,
                com.stakhovskyi.grpc.Order.InventoryResponse>(
  ...
  public static final class InventoryServiceBlockingStub extends io.grpc.stub.AbstractStub<InventoryServiceBlockingStub> {
    ...
    /**
     */
    public com.stakhovskyi.grpc.Order.InventoryResponse isInStock(com.stakhovskyi.grpc.Order.InventoryRequest request) {
  ...
  public static final class InventoryServiceFutureStub extends io.grpc.stub.AbstractStub<InventoryServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stakhovskyi.grpc.Order.InventoryResponse> isInStock(
        com.stakhovskyi.grpc.Order.InventoryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_IS_IN_STOCK:
          serviceImpl.isInStock((com.stakhovskyi.grpc.Order.InventoryRequest) request,
              (io.grpc.stub.StreamObserver<com.stakhovskyi.grpc.Order.InventoryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class InventoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.stakhovskyi.grpc.Order.getDescriptor();
    }
